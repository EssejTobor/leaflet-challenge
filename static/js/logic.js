...
var orogensURL = 'https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_orogens.json';
var stepsURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_steps.json";
...
var orogensLayer = L.layerGroup();

d3.json(orogensURL, function(data) {
    orogensLayer.addLayer(L.geoJSON(data, {
        style: {
            color: "pink",
            fillOpacity: .5,
            weight: 2
        ...
        onEachFeature: function(feature, layer) {
            layer.bindPopup(`Orogen: ${feature.properties.Name}`)
        }
    }));
});

var stepsLayer = L.layerGroup();

d3.json(stepsURL, function(data) {
    stepsLayer.addLayer(L.geoJSON(data, {
        style: {
            color: "blue",
            fillOpacity: .5,
            weight: 2
        ...
        onEachFeature: function(feature, layer) {
            layer.bindPopup(`Step Boundary: ${feature.properties.none}`)
        }
    }));
});
...
var myMap = L.map("map", {
    ...
    minZoom: 2,
    maxZoom: 17,
    layers: [Esri_WorldImagery, quakeMarkers],
    maxBounds: bounds,
